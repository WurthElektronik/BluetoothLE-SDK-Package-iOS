...
/// AmberUartConfig defines the uart configuration of the Amber bluetooth device protocol.
public class AmberUartConfig: UartConfig {
    ...
    public static var minimumRSSI: Int? = nil
    ...
    public static var maximumBadRSSICount: Int? = nil
}
